package com.video_editor.photoeditorapp1.ActivityVideoCollage.CollageUtils;
    ...
    public Bitmap drawCanvas() {
        ...
        for (int i3 = 0; i3 < CollageUtils.clgstickerviewsList.size(); i3++) {
            try {
                ...
                com.video_editor.photoeditorapp1.ActivityVideoCollage.CollageBitmapUtils.CollageUtils.width = collageSingleFingerView.getImageWidth();
                ...
                if (bitmapDrawable.getBitmap() != null) {
                    try {
                        ...
                        Bitmap createScaledBitmap = Bitmap.createScaledBitmap(bitmap, com.video_editor.photoeditorapp1.ActivityVideoCollage.CollageBitmapUtils.CollageUtils.width, imageHeight, true);
