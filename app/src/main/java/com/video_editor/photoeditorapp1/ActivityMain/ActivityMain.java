package com.video_editor.photoeditorapp1.ActivityMain;
...
import com.video_editor.photoeditorapp1.ActivityVideoList.ActivityVideoList;
import com.video_editor.photoeditorapp1.ActivityVideoMusicList.ActivityVideoMusicList;
...
public class ActivityMain extends AppCompatActivity {
 ...
 builder.forUnifiedNativeAd(new UnifiedNativeAd.OnUnifiedNativeAdLoadedListener() {
    ...
    public void videojoin(View view) {
        ...
        final Intent intent = new Intent(this, com.video_editor.photoeditorapp1.ActivityVideoJoiner.ActivityVideoList.class);
        intent.setFlags(67108864);
        if (mInterstitialAd != null && mInterstitialAd.isLoaded()) {
            mInterstitialAd.show();
            mInterstitialAd.setAdListener(new AdListener() {
    ...
    public void videotoimg(View view) {
        ...
        final Intent intent = new Intent(this, com.video_editor.photoeditorapp1.ActivityVideoGIF.ActivityVideoList.class);
        intent.setFlags(67108864);
        if (mInterstitialAd != null && mInterstitialAd.isLoaded()) {
            mInterstitialAd.show();
            mInterstitialAd.setAdListener(new AdListener() {
